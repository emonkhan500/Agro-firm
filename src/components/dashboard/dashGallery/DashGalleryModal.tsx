...
const DashGalleryModal = ({ onClose, onSubmit }: Props) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-2">
      ...
      <div className="relative w-full max-w-2xl rounded-lg bg-white shadow-lg">
        ...
        <div className="max-h-[80vh] overflow-y-auto px-6 py-6 space-y-5">
          ...
          {/* Size */}
          <div>
            <label className="text-sm font-medium mr-2">Thumbnail Size</label>
            <select
              value={size}
          ...
          <div>
            ...
            <label className="mt-2 flex h-36 cursor-pointer items-center justify-center border-2 border-dashed rounded">
              {coverPreview ? (
                <img
                  src={coverPreview}
          ...
          <div>
            ...
            <label className="mt-2 flex min-h-[100px] cursor-pointer items-center justify-center border-2 border-dashed rounded">
          ...
          <div>
            ...
            <div className="flex gap-2 mt-2 flex-wrap">
              ...
              {imagePreviews.length < 4 && (
                <label className="h-20 w-20 border-2 border-dashed flex items-center justify-center cursor-pointer rounded">
                  <Upload size={18} />
                  <input
                    hidden
                    type="file"
        ...
        <div className="flex justify-end gap-3 border-t px-6 py-4">
          ...
          <button
            ...
            className="bg-active-nav text-white px-5 py-2 rounded"
          >
            Add Item
          </button>
        </div>
...
export default DashGalleryModal;
