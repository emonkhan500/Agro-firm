        ...
        <div className="flex gap-4 lg:gap-7">
          ...
          <div className=" flex items-center w-full py-8 md:py-10 xl:py-0 md:w-1/2 xl:max-w-[628px] relative z-10  text-center md:text-start">
            <div className="text-white">
              <h2 className="text-[18px] md:text-[24px] lg:text-[30px] xl:text-[46px] font-medium leading-[120%]">
                Our Exclusive & Premium Cattle Collection
              </h2>
              <Link href="/cattle" className="btn btn-primary mt-4">
                {' '}
                <button className="mt-2 md:mt-6 bg-btn-bg text-[10px] md:text-[16px] text-primary-text font-semibold h-[24px] md:h-[39px] w-[120px] md:w-[208px] rounded-full hover:bg-btn-hover-bg transition">
                  Explore Best Cattle
                </button>
              </Link>
            </div>
