  ...
  return (
    <section className=" mt-0 md:mt-10 lg:mt-19 mb-0 lg:mb-31  xl:max-h-[531px]">
      <div className="wraper px-5 md:px-16 xl:px-20 flex flex-col lg:flex-row gap-5 pt-6">
        ...
        {/* RIGHT CONTENT */}
        <div className="flex flex-col gap-2 md:gap-4 lg:items-start lg:justify-start w-full xl:w-1/2 md:space-y-1.5 mt-0 md:mt-10 lg:mt-23 xl:ml-1.5">
          <p className=" text-[14px] font-medium text-active-nav underline leading-[100%]">
            Contact Us
          </p>
          <p className="text-[20px] md:text-[32px] font-semibold md:font-medium leading-[125%] text-primary-text mt-1 md:mt-0">
            Have a question? Our team is ready to assist you anytime.
          </p>
          <p className="text-[14px] font-normal leading-[120%] text-primary-text mt-1 md:mt-0">
